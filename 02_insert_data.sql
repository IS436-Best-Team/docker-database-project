...
('Marcus', 'Johnson',  'marcus@shenanigans.com',  '$2b$12$abc123hashedpassword1', 'head_coach',  TRUE),
('Diana',  'Torres',   'diana@shenanigans.com',   '$2b$12$abc123hashedpassword2', 'head_coach',  TRUE),
('Kevin',  'Patel',    'kevin@shenanigans.com',   '$2b$12$abc123hashedpassword3', 'assistant',   TRUE),
('Sandra', 'Williams', 'sandra@shenanigans.com',  '$2b$12$abc123hashedpassword4', 'head_coach',  TRUE);

-- -------------------------------------------------------------
-- TeamCoach (assign coaches to teams)
-- -------------------------------------------------------------
...
-- -------------------------------------------------------------
-- GameRoster (Game 1 - Blue Thunder vs Red Rockets)
-- -------------------------------------------------------------
...
-- -------------------------------------------------------------
-- PlayerGameStatus (Game 1 tracking)
-- -------------------------------------------------------------
